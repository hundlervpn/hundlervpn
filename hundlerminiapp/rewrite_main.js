...
const content = `# Hundler Mini App — Свод Правил (MINIAPP-AGENTS)
...
2. **База данных:** Переехали на Hostman Managed PG (\`132.243.242.196\`). Старый Timeweb IP мертв. **НИКОГДА не коммитить пароли от БД** в исходники. Используйте переменные окружения.
...
fs.writeFileSync('hundlerminiapp/MINIAPP-AGENTS.md', content, 'utf-8');
